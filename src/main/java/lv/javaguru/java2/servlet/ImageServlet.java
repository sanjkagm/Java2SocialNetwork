...
/**
 * Created by Pavel on 12.11.2016..
 */
import java.io.File;
...
public class ImageServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.imagePath = getServletContext().getInitParameter("upload-dir");

        this.defaultAvatar = getServletContext().getInitParameter("avatar-default");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!image.exists()) {
            ...
            image = new File(imagePath, URLDecoder.decode(defaultAvatar, "UTF-8"));
